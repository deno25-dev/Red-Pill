...
export const FinancialChart: React.FC<ChartProps> = (props) => {
  ...
  // Production-Safe Scroll: Wrapped in requestAnimationFrame
      ...
      requestAnimationFrame(() => {
          ...
          if (shouldSnap) { 
              if (isReplayActive) { 
                  ...
                  timeScale.setVisibleLogicalRange({ from: targetFrom as Logical, to: targetTo as Logical } as LogicalRange); 
              } else { 
                  timeScale.scrollToRealTime(); 
              } 
          } 
  ...
  useEffect(() => { 
      ...
      try { 
          // Disable auto-shift momentarily during bulk update to prevent jump
