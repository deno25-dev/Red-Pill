...
export const FinancialChart: React.FC<ChartProps> = (props) => {
  ...
  // Mandate 1.1.1: Persistent Precision (Cursor Guard)
  useEffect(() => {
      const container = chartContainerRef.current;
      if (!container) return;

      const enforceCursor = () => {
          // Only override if it's 'default'. 
          // If the app sets it to 'wait', 'crosshair', 'pointer', etc., leave it.
