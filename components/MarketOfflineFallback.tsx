  ...
  return (
    <div className="flex flex-col items-center justify-center w-full p-6 text-center bg-panel-bg border-t border-app-border min-h-[240px]">
      <div className="relative mb-6 group">
        ...
        <div className="absolute inset-0 bg-accent/5 rounded-full blur-xl group-hover:bg-accent/10 transition-all duration-500"></div>
        
        <div className="relative p-4 rounded-full bg-app-bg border border-app-border shadow-xl ring-1 ring-white/5">
          <WifiOff size={28} className="text-text-secondary group-hover:text-accent transition-colors duration-300" />
        </div>
      ...
      <button
        onClick={onRetry}
        className="group relative flex items-center gap-2 px-6 py-2 text-[11px] font-bold tracking-wide transition-all duration-200 rounded border border-accent/30 text-accent hover:bg-accent hover:text-white hover:border-transparent active:scale-[0.98]"
      >
